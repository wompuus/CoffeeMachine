...
while running:
    ...
    # TODO: 3 Print a report of all of the resources. (This includes the money in the machine)
        ...
        report()
    # TODO: 4 Check if the resources in the machine are enough to make the drink - if any 1 is out print "Sorry there
    #  is not enough resources"
    elif choice == "espresso" or choice == "latte" or choice == "cappuccino":
        enough_resource = resource_check(MENU[choice])
        # TODO: 5 Process coins. If there are enough resources to make the drink, ask user for coins. Quarters,
        ...
        # TODO: 7.3 If the user entered too much money, machine offers change.
            ...
            # TODO: 8 Make the coffee if the transaction is successful, and the ingredients should be deducted from
